...
CREATE TABLE IF NOT EXISTS `rezendeapp`.`checklist` (
  ...
  INDEX `fk_checklist_categoria_idx` (`categoria_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `rezendeapp`.`tarefa` (
  ...
  INDEX `fk_tarefa_checklist2_idx` (`checklist_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `rezendeapp`.`pergunta` (
  ...
  INDEX `fk_pergunta_tarefa1_idx` (`tarefa_id` ASC) VISIBLE,
