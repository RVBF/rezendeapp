...
CREATE TABLE IF NOT EXISTS `rezendeapp`.`tarefa` (
  ...
  `checklist_categoria_id` INT NOT NULL,
  PRIMARY KEY (`id`, `checklist_id`, `checklist_categoria_id`),
  INDEX `fk_tarefa_checklist2_idx` (`checklist_id` ASC, `checklist_categoria_id` ASC),
  CONSTRAINT `fk_tarefa_checklist2`
    FOREIGN KEY (`checklist_id` , `checklist_categoria_id`)
    REFERENCES `rezendeapp`.`checklist` (`id` , `categoria_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
