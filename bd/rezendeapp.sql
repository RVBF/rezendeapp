...
CREATE TABLE IF NOT EXISTS `anexos` (
  ...
  `questionamento_id` INT NOT NULL,
  PRIMARY KEY (`id`, `questionamento_id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `planoacao` (
  ...
  `descricaosolucao` VARCHAR(225) NOT NULL,
  `datalimite` DATETIME NOT NULL,
  `dataexecucao` DATETIME NULL,
  `datacadastro`  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `reponsavel_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`, `reponsavel_id`))
ENGINE = InnoDB;
...
BEGIN
    ...
    loop_label:  LOOP
		...
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"1","pergunta":"Pergunta 01 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"2","pergunta":"Pergunta 02 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"3","pergunta":"Pergunta 03 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"4","pergunta":"Pergunta 04 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"1","pergunta":"QUestão 01 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"2","pergunta":"Questão 02 :"}', ultimoID, 0);
		INSERT INTO `questionamento`(status, formulariopergunta, checklist_id, planoacao_id) VALUES ('Não Respondido', '{"id":"3","pergunta":"QUestão 03 :"}', ultimoID, 0);
        SET  x = x + 1;
		ITERATE  loop_label;
    END LOOP;
  End$$
...
START TRANSACTION;
USE `rezendeapp`;
INSERT INTO `colaborador` (`id`, `nome`, `sobrenome`, `email`, `usuario_id`, `setor_id`) VALUES (1, 'Admin', 'Sistema', 'sistema@rezendeconstrucao.com.br', 1, 1);
