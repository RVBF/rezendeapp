...
START TRANSACTION;
USE `rezendeapp`;
INSERT INTO `loja` (`id`, `razaoSocial`, `nomeFantasia`, `deleted_at`) VALUES (1, 'Rezende Construção', 'Matriz', NULL);
INSERT INTO `loja` (`id`, `razaoSocial`, `nomeFantasia`, `deleted_at`) VALUES (2, 'Rezende Construção', 'Duque', NULL);
INSERT INTO `loja` (`id`, `razaoSocial`, `nomeFantasia`, `deleted_at`) VALUES (3, 'Rezende Construção', 'Conselheiro', NULL);
